...
def irrigation_ui():
    ...
    # =========================================================
        ...
        if submitted:
            ...
            st.success(
                f"✅ {water_used} liters used on "
                f"{current_crop} recorded for "
                f"{current_farm_name} on {date}."
            )
